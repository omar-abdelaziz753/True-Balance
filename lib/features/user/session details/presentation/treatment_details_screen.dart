                      ...
                      children: [
                        ClipRRect(
                            ...
                            child: CacheNetworkImagesWidget(
                              image:
                                  cubit.treatmentPlanDetail?.therapist.image ??
                                      '',
                              width: 55.w,
                              height: 55.h,
                            )),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                cubit.treatmentPlanDetail?.therapist
                                        .specialization ??
                                    '',
                                style: Styles.footnoteEmphasis.copyWith(
                                  color: AppColors.neutralColor600,
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            const Spacer(),
                            Text(
                              cubit.treatmentPlanDetail?.numberOfSessions
                                      .toString() ??
                                  "0",
                              style: Styles.contentEmphasis.copyWith(
                                color: AppColors.neutralColor1000,
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            overflow: TextOverflow.ellipsis,
                                            maxLines: 2,
                                            'Session ${(cubit.completedSessions[index].index!) + 1}',
                                            style:
                                                Styles.captionEmphasis.copyWith(
                                              color: AppColors.neutralColor1000,
                                            ),
