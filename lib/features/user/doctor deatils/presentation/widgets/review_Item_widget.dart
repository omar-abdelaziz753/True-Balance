          ...
          Row(
            children: [
              CircleAvatar(
                ...
                backgroundImage: userRating.userImage != null &&
                        userRating.userImage!.isNotEmpty
                    ? CachedNetworkImageProvider(userRating.userImage!)
                    : null,
                child: (userRating.userImage == null ||
                        userRating.userImage!.isEmpty)
