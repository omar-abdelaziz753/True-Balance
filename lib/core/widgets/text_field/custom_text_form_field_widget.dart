...
class _CustomTextFormFieldWidgetState extends State<CustomTextFormFieldWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle currentHintStyle = (widget.hintStyle ?? Styles.captionRegular).copyWith(
    ...
    return TextFormField(
      ...
      onTapOutside: widget.isChat ? null : (event) => FocusScope.of(context).unfocus(),
      decoration: InputDecoration(
        alignLabelWithHint: true,
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(widget.borderRadius ?? AppConstants.borderRadius),
          borderSide: BorderSide.none,
        ),
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(widget.borderRadius ?? AppConstants.borderRadius),
