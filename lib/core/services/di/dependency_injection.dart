...
// >>>>>>> main
  ...
  getIt.registerLazySingleton<AppointmentsApiServices>(
      () => AppointmentsApiServices(getIt()));
  getIt.registerLazySingleton<AppointmentsRepos>(
      () => AppointmentsRepos(getIt()));

  getIt.registerLazySingleton<AppointmentsDetailsApiServices>(
      () => AppointmentsDetailsApiServices(getIt()));
  getIt.registerLazySingleton<AppointmentsDetailsRepos>(
      () => AppointmentsDetailsRepos(getIt()));

  getIt.registerLazySingleton<DetailsForTherapistsApiServices>(
